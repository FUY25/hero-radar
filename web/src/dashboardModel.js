...
export function layer2RunOptionsFromConfig(config = {}) {
  ...
  return {
    ...
    layer2_scoring_output_schema_version: String(scoring.output_schema_version || 'layer2-scoring-output-v2'),
    layer2_scoring_context_policy_version: String(scoring.context_policy_version || 'layer2-scoring-context-v1'),
